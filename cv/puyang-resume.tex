...
\sectiontable{Research Experience}{
    \entry{AI Security}{AI firewall, secure AI agents, content safety, and model poisoning defense}
    \entry{AI Agents \& SLMs}{Agentic workflow security, small language model adaptation, and KV cache optimization}
    \entry{Diffusion Models}{Discrete diffusion language models for AI security dataset synthesis}
    \entry{Computer Networks}{6G network architecture, delay-guaranteed routing, and wireless avionics communications}
}
...
\sectiontable{Professional Service}{
    \entry{Reviewer}{Top-tier conferences and journals, including IEEE INFOCOM, IEEE/ACM Transactions on Networking (ToN), Computer Networks, IEEE Internet of Things Journal, and ACM SIGKDD (KDD)}
}

\sectiontable{Awards \& Scholarships}{
    \entry{2023}{Chinese Government Award for Outstanding Self-financed Students Abroad; UVic Graduate Fellowship}
    \entry{2020--2022}{UVic Graduate Fellowship; Excellent Research Intern Achievement}
